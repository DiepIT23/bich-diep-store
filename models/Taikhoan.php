...
function update_mk($id_user, $ten_dang_nhap, $mat_khau)
{
    $sql = " UPDATE taikhoan SET user='$ten_dang_nhap',mat_khau='$mat_khau' WHERE id_user = '$id_user'";
    pdo_execute($sql);
}
function loadone_tk($id_user)
{
    $sql = "SELECT * FROM tai_khoan WHERE id_user='$id_user'";
